(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-project__slider")) new swiper_core_Swiper(".slider-project__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".slider-project__slider .swiper-button-prev",
                nextEl: ".slider-project__slider .swiper-button-next"
            },
            on: {}
        });
    }
    ...
    if (projectSection) document.documentElement.classList.add("project-page");
    ...
    window.addEventListener("DOMContentLoaded", (() => {
        ...
        if (spollers.length) spollers.forEach((spoller => {
            ...
            if (spollerItems.length) spollerItems.forEach((item => {
                ...
                if (spollerBody) {
                    ...
                    if (isMobile.any()) item.addEventListener("click", (() => {
        ...
        if (popups.length > 0) popups.forEach((trigger => {
        ...
        if (closeButtons.length > 0) closeButtons.forEach((closeButton => {
        ...
        if (allPopups.length > 0) allPopups.forEach((popup => {
        ...
        if (videoBlocks.length > 0) videoBlocks.forEach((block => {
            const video = block.querySelector("video");
            const playButton = block.querySelector(".video-project__play");
            if (video && playButton) playButton.addEventListener("click", (() => {
